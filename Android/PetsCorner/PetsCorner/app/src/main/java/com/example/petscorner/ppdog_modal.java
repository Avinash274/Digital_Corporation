...
public class ppdog_modal {

    private String uImageView,uName,uEmailId,pAmount,pImage,pTitle,pBreed,pGender,pAbout,pId,pOwnerId;

    public ppdog_modal(String uImageView, String uName, String uEmailId, String pAmount, String pImage, String pTitle, String pBreed, String pGender, String pAbout, String pId, String pOwnerId) {
