...
public class View_Pet_Requests_Modal {

    private String uName,uemailId,uImageView,uDescription,uLocation,uContact,uId;

    public View_Pet_Requests_Modal(String uName, String uemailId, String uImageView, String uDescription, String uLocation, String uContact, String uId) {
        this.uName = uName;
